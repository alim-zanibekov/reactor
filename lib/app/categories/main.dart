  ...
  Widget build(BuildContext context) {
    return Column(children: <Widget>[
      _children(
        context,
        'Anime',
        'https://joyreactor.cc/images/category/300/anime.jpg',
        Tag('Anime', prefix: 'anime'),
      ),
      _children(
        context,
        'Эротика',
        'https://joyreactor.cc/images/category/300/erot.jpg',
        Tag('эротика', link: 'эротика'),
      ),
      _children(
        context,
        'Игры',
        'https://joyreactor.cc/images/category/300/games.jpg',
        Tag('игры', link: 'игры'),
      ),
      _children(
        context,
        'Политота',
        'https://joyreactor.cc/images/category/politota.png',
        Tag('политота', link: 'политота'),
      ),
      _children(
        context,
        'anon',
        'https://joyreactor.cc/images/category/300/anon.jpg',
        Tag('anon', link: 'anon'),
      ),
      _children(
        context,
        'Фэндомы',
        'https://joyreactor.cc/images/category/300/fandome.jpg',
        Tag('фэндомы', link: 'фэндомы', isMain: true),
      ),
      _children(
        context,
        'Разное',
        'https://joyreactor.cc/images/category/300/raznoe.jpg',
